...
Description : Write a program to execute ls -Rl by using the system call execlp
...
-rw-r--r--@ 1 rohit2026  staff    523  7 Sep 18:11 27_b.c
-rwxr-xr-x  1 rohit2026  staff  33512  7 Sep 18:11 a.out
