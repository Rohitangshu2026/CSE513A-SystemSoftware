...
Description : Write a program to execute ls -Rl by using the system call execl
...
-rw-r--r--@ 1 rohit2026  staff    695  7 Sep 18:07 27_a.c
-rwxr-xr-x  1 rohit2026  staff  33512  7 Sep 18:08 a.out
