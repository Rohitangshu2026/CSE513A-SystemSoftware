...
Description : Write a program to execute ls -Rl by using the system call execvp
...
-rw-r--r--@ 1 rohit2026  staff   3188  7 Sep 18:24 27_e.c
-rwxr-xr-x  1 rohit2026  staff  33656  7 Sep 18:24 a.out
